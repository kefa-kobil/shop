/*
  ...
  4. Sample Data
    - Create cashier profile using existing user
    - Sample POS session and transactions
*/
...
-- Update existing manager to also serve as cashier for demo purposes
UPDATE profiles 
SET role = 'manager' 
...
INSERT INTO pos_sessions (cashier_id, register_number, opening_cash, status, opened_at) VALUES
  ('22222222-2222-2222-2222-222222222222', 'REG-001', 200.00, 'open', now() - interval '2 hours')
